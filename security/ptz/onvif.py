...
from security.config import SecurityConfig, ZoomingModeEnum
from security.util.builtin import find_by_key
...
class OnvifController:
    ...
    def __init__(
        self, config: SecurityConfig, ptz_metrics: dict[str, PTZMetrics]
    ) -> None:
