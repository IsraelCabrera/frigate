...
from security.comms.detections_updater import DetectionPublisher, DetectionTypeEnum
from security.comms.inter_process import InterProcessRequestor
from security.config import CameraConfig, CameraInput, FfmpegConfig, SecurityConfig
...
from security.data_processing.common.audio_transcription.model import (
    AudioTranscriptionModelRunner,
)
from security.data_processing.real_time.audio_transcription import (
    AudioTranscriptionRealTimeProcessor,
)
from security.ffmpeg_presets import parse_preset_input
from security.log import LogPipe, redirect_output_to_logger
from security.object_detection.base import load_labels
from security.util.builtin import get_ffmpeg_arg_list
from security.util.process import SecurityProcess
from security.video import start_or_restart_ffmpeg, stop_ffmpeg
...
class AudioProcessor(SecurityProcess):
    name = "security.audio_manager"
    ...
    def __init__(
        ...
        super().__init__(
            stop_event, PROCESS_PRIORITY_HIGH, name="security.audio_manager", daemon=True
        )
