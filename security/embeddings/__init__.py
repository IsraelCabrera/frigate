...
from security.const import CONFIG_DIR, FACE_DIR, PROCESS_PRIORITY_HIGH
...
from security.util.classification import kickoff_model_training
...
class EmbeddingProcess(SecurityProcess):
    def __init__(
        self,
        ...
        super().__init__(
            ...
            name="security.embeddings_manager",
            daemon=True,
        )
        self.config = config
