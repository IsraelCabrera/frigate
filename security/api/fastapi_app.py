...
from security.api import app as main_app
...
from security.api.auth import get_jwt_secret, limiter
...
def create_fastapi_app(
    ...
    if security_config.auth.failed_login_rate_limit is None:
        limiter.enabled = False
    else:
        auth.rateLimiter.set_limit(security_config.auth.failed_login_rate_limit)
    ...
    if security_config.auth.enabled:
