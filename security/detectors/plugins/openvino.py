...
from security.detectors.detection_runners import OpenVINOModelRunner
from security.detectors.detector_config import BaseDetectorConfig, ModelTypeEnum
from security.util.model import (
    post_process_dfine,
    post_process_rfdetr,
    post_process_yolo,
)
...
class OvDetector(DetectionApi):
    ...
    ## returns an array that's easily passable back to Security.
