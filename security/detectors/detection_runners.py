...
from security.util.model import get_ort_providers
from security.util.rknn_converter import auto_convert_model, is_rknn_compatible
...
class ONNXModelRunner(BaseModelRunner):
    ...
    def is_migraphx_complex_model(model_type: str) -> bool:
        # Import here to avoid circular imports
        from security.detectors.detector_config import ModelTypeEnum
        from security.embeddings.types import EnrichmentModelTypeEnum
