...
class AlertsConfig(SecurityBaseModel):
    """Configure alerts"""
...
class DetectionsConfig(SecurityBaseModel):
...
class GenAIReviewConfig(SecurityBaseModel):
    enabled: bool = Field(
        default=False,
...
class ReviewConfig(SecurityBaseModel):
    """Configure reviews"""
