...
class FilterConfig(SecurityBaseModel):
...
class GenAIObjectTriggerConfig(SecurityBaseModel):
...
class GenAIObjectConfig(SecurityBaseModel):
...
class ObjectConfig(SecurityBaseModel):
