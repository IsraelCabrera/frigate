...
from security.const import DEFAULT_FFMPEG_VERSION, INCLUDED_FFMPEG_VERSIONS
...
class FfmpegOutputArgsConfig(SecurityBaseModel):
...
class FfmpegConfig(SecurityBaseModel):
...
class CameraInput(SecurityBaseModel):
