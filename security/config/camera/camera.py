...
from security.const import CACHE_DIR, CACHE_SEGMENT_FORMAT, REGEX_CAMERA_NAME
...
class CameraConfig(SecurityBaseModel):
    name: Optional[str] = Field(None, title="Camera name.", pattern=REGEX_CAMERA_NAME)

    friendly_name: Optional[str] = Field(
        None, title="Camera friendly name used in the Security UI."
    )
