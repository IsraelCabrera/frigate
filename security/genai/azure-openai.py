"""Azure OpenAI Provider for Security AI."""
...
from security.config import GenAIProviderEnum
from security.genai import GenAIClient, register_genai_provider
...
class OpenAIClient(GenAIClient):
    """Generative AI client for Security using Azure OpenAI."""
