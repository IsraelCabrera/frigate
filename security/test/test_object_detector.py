...
import security.detectors as detectors
import security.object_detection.base
from security.config import DetectorConfig, ModelConfig
from security.detectors import DetectorTypeEnum
from security.detectors.detector_config import InputTensorEnum
...
class TestLocalObjectDetector(unittest.TestCase):
        ...
        for det_type in detectors.api_types:
            with self.subTest(det_type=det_type):
                with patch.dict(
                    ...
                    test_obj = security.object_detection.base.LocalObjectDetector(
    ...
    def test_detect_raw_given_tensor_input_should_return_api_detect_raw_result(self):
        ...
        test_obj_detect = security.object_detection.base.LocalObjectDetector(
    ...
    @patch("security.object_detection.base.load_labels")
