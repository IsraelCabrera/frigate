...
class TestCameraAccessEventReview(BaseTestHttp):
    ...
    def test_event_single_access(self):
        ...
        with patch("security.api.event.require_camera_access", mock_require_allowed):
            with TestClient(self.app) as client:
        ...
        with patch("security.api.event.require_camera_access", mock_require_disallowed):
            with TestClient(self.app) as client:
                resp = client.get("/events/event1")
    ...
    def test_review_single_access(self):
        ...
        with patch("security.api.review.require_camera_access", mock_require_allowed):
            with TestClient(self.app) as client:
        ...
        with patch("security.api.review.require_camera_access", mock_require_disallowed):
            with TestClient(self.app) as client:
                resp = client.get("/review/rev1")
                assert resp.status_code == 403
