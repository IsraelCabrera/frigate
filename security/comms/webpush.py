"""Handle sending notifications for Security via Firebase."""
...
class WebPushClient(Communicator):
    """Security wrapper for webpush client."""
    ...
    def send_notification_test(self) -> None:
        ...
        for user in self.web_pushers:
            self.send_push_notification(
                ...
                message="This is a test notification from Security.",
                direct_url="/",
    ...
    def send_alert(self, payload: dict[str, Any]) -> None:
        ...
        image = f"{payload['after']['thumb_path'].replace('/media/security', '')}"
