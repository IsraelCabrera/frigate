"""Handle communication between Security and other applications."""
...
from security.camera import PTZMetrics
from security.camera.activity_manager import AudioActivityManager, CameraActivityManager
...
from security.models import Event, Previews, Recordings, ReviewSegment
from security.ptz.onvif import OnvifCommandEnum, OnvifController
from security.types import ModelStatusTypesEnum, TrackedObjectUpdateTypesEnum
from security.util.object import get_camera_regions_grid
from security.util.services import restart_security

logger = logging.getLogger(__name__)


class Dispatcher:
    """Handle communication between Security and communicators."""
