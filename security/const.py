...
CONFIG_DIR = "/config"
DEFAULT_DB_PATH = f"{CONFIG_DIR}/security.db"
MODEL_CACHE_DIR = f"{CONFIG_DIR}/model_cache"
BASE_DIR = "/media/security"
...
CACHE_DIR = "/tmp/cache"
SECURITY_LOCALHOST = "http://127.0.0.1:5000"
PLUS_ENV_VAR = "PLUS_API_KEY"
PLUS_API_HOST = "https://api.security.video"
...
JWT_SECRET_ENV_VAR = "SECURITY_JWT_SECRET"
