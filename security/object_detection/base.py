...
from security.comms.object_detector_signaler import (
    ObjectDetectorPublisher,
    ObjectDetectorSubscriber,
)
from security.config import SecurityConfig
from security.const import PROCESS_PRIORITY_HIGH
from security.detectors import create_detector
from security.detectors.detector_config import (
    BaseDetectorConfig,
    InputDTypeEnum,
    ModelConfig,
)
from security.util.builtin import EventsPerSecond, load_labels
...
class DetectorRunner(SecurityProcess):
    def __init__(
        self,
        name,
...
class AsyncDetectorRunner(SecurityProcess):
    def __init__(
        self,
        name,
        detection_queue: Queue,
...
class ObjectDetectProcess:
    def __init__(
        ...
        self.detect_process: SecurityProcess | None = None
        self.config = config
        self.detector_config = detector_config
