...
from security.comms.review_updater import ReviewDataPublisher
...
from security.models import ReviewSegment
from security.review.types import SeverityEnum
from security.track.object_processing import ManualEventState, TrackedObject
from security.util.image import SharedMemoryFrameManager, calculate_16_9_crop
...
class ReviewSegmentMaintainer(threading.Thread):
    ...
    def __init__(self, config: SecurityConfig, stop_event: MpEvent):
