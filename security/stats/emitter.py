...
from security.const import FREQUENCY_STATS_POINTS
from security.stats.prometheus import update_metrics
from security.stats.util import stats_snapshot
...
class StatsEmitter(threading.Thread):
    def __init__(
        ...
        super().__init__(name="security_stats_emitter")
        self.config = config
