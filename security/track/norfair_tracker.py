...
from security.config import CameraConfig
from security.ptz.autotrack import PtzMotionEstimator
from security.track import ObjectTracker
from security.track.stationary_classifier import (
...
from security.util.object import average_boxes, median_of_boxes
...
def security_distance(detection: Detection, tracked_object: TrackedObject) -> float:
    ...
    def __init__(
        ...
        self.object_type_configs = {
            "car": {
                ...
                "distance_function": security_distance,
