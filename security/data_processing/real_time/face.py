...
from security.const import FACE_DIR, MODEL_CACHE_DIR
from security.data_processing.common.face.model import (
    ArcFaceRecognizer,
    FaceNetRecognizer,
    FaceRecognizer,
)
...
class FaceRealTimeProcessor(RealTimeProcessorApi):
    def __init__(
        ...
        if not all(
            ...
            from security.util.downloader import ModelDownloader
