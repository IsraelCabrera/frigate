"""Handle outputting raw security frames"""
...
from security.comms.ws import WebSocket
from security.config import SecurityConfig
from security.config.camera.updater import (
    CameraConfigUpdateEnum,
    CameraConfigUpdateSubscriber,
)
from security.const import CACHE_DIR, CLIPS_DIR, PROCESS_PRIORITY_MED
from security.output.birdseye import Birdseye
from security.output.camera import JsmpegCamera
from security.output.preview import PreviewRecorder
from security.util.image import SharedMemoryFrameManager, get_blank_yuv_frame
...
class OutputProcess(SecurityProcess):
    def __init__(self, config: SecurityConfig, stop_event: MpEvent) -> None:
        super().__init__(
            stop_event, PROCESS_PRIORITY_MED, name="security.output", daemon=True
        )
        self.config = config
