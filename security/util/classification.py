...
from security.comms.embeddings_updater import EmbeddingsRequestEnum, EmbeddingsRequestor
from security.comms.inter_process import InterProcessRequestor
from security.config import FfmpegConfig
...
from security.log import redirect_output_to_logger
from security.models import Event, Recordings, ReviewSegment
from security.types import ModelStatusTypesEnum
...
class ClassificationTrainingProcess(SecurityProcess):
