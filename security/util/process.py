...
import security.log
from security.config.logger import LoggerConfig
...
class SecurityProcess(BaseProcess):
    logger: logging.Logger

    def before_start(self) -> None:
        self.__log_queue = security.log.log_listener.queue
