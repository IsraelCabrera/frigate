...
export default function StorageMetrics({
  ...
  const { data: stats } = useSWR<SecurityStats>("stats");
  ...
  const totalStorage = useMemo(() => {
    ...
    const totalStorage = {
      used: stats.service.storage["/media/security/recordings"]["used"],
      camera: 0,
      total: stats.service.storage["/media/security/recordings"]["total"],
    };
                ...
                <PopoverContent className="w-80">
                  <div className="space-y-2">
                    ...
                    <div className="mt-2 flex items-center text-primary">
                      <Link
                        to={getLocaleDocUrl(
                          "security/installation#calculating-required-shm-size",
                        )}
                        target="_blank"
