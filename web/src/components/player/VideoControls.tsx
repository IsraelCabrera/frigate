...
import SecurityPlusIcon from "../icons/SecurityPlusIcon";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
type SecurityPlusUploadButtonProps = {
  video?: HTMLVideoElement | null;
  onOpen: () => void;
  onClose: () => void;
  onUploadFrame: () => void;
...
function SecurityPlusUploadButton({
  video,
  onOpen,
  onClose,
  onUploadFrame,
  ...
  return (
    ...
    >
      ...
      >
        <AlertDialogHeader>
          <AlertDialogTitle>{t("submitSecurityPlus.title")}</AlertDialogTitle>
        </AlertDialogHeader>
